# -*- coding: utf-8 -*-
"""
Created on Fri Oct 29 04:57:23 2021
...
date_start=[2021,1,15] # year,month,day,
date_end=[2021,2,15]
date_interval= 1#days
date_current=datetime(date_start[0],date_start[1],date_start[2])
date_start=datetime(date_start[0],date_start[1],date_start[2]) #[2021,3,1]
date_end=datetime(date_end[0],date_end[1],date_end[2]) #[2021,3,1]
time_step=1#days
